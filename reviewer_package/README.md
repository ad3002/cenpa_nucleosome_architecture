...
[![Reproducibility](https://img.shields.io/badge/reproducibility-verified-brightgreen.svg)](reproduce.sh)
...
* **Reviewer Guide & Audit Traceability Matrix:** [`REVIEWER_GUIDE.md`](REVIEWER_GUIDE.md)
...
├── REVIEWER_GUIDE.md          # Comprehensive Reviewer & Auditor Guide
...
├── reproduce.sh                # Master verification suite with dynamic assert checks (~15s)
├── paper/
