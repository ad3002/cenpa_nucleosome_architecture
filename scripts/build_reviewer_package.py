...
| **CHM13_REP1** | CHM13hTERT | CENP-A ChIP | `SRR13278684` | `SRR13278682` (Input) | `PRJNA559484` | Biological Replicate (Package G, $N = 74,925$ pairs) |
| **HG002_T2T** | HG002 (EBV-LCL) | CENP-A CUT&RUN | `SRR15395857` | `SRR15395854` (IgG) | `PRJNA752795` | Diploid Validation (Package G, $N = 11,456$ pairs) |
| **RPE1_CENPA** | hTERT RPE-1 | CENP-A CUT&RUN | `SRR9201843` | `SRR9201844` (CENP-B) | `PRJNA546288` | Non-Transformed Diploid ($N = 12,923$ pairs) |
| **RPE1_CENPB** | hTERT RPE-1 | CENP-B CUT&RUN | `SRR9201844` | Structural Comparator | `PRJNA546288` | Sequence-Specific Factor Comparator ($N = 1,308$ pairs) |
...
def assemble_package_directory():
    ...
    readme_replacements = {
        "run_reproduction.sh": "reproduce.sh",
        "REVIEWER_PACKAGE_GUIDE.md": "REVIEWER_GUIDE.md",
        "cenpa_reviewer_package_v3.1.tar.gz": "../cenpa_reviewer_package_v3.1.tar.gz",
        "cenpa_reviewer_package_v3.1.zip": "../cenpa_reviewer_package_v3.1.zip",
