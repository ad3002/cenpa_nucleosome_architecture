...
def build_ledger():
    ...
    metrics = {
        ...
        "sample_counts": {
            ...
            "chip_proper_pairs_cdr_mononucleosome_gated_130_175bp": 411919,
        ...
        "cenpb_box_geometry": {
            ...
            "peak_to_dyad_contrast_ratio": round(peak1_55_count / dyad_15_count, 2),
            "geometric_null_expected_15bp": 38333.62,
            "depletion_ratio_vs_geometric_null_15bp": round(38333.62 / dyad_15_count, 2)
        },
        "cdr_phasogram": {
            ...
            "total_cdr_dyads_mononucleosome_gated": 411919
        },
        "linker_geometry": {
            ...
            "cdr_model_alternating_linker1_bp": 20,
            "cdr_model_alternating_linker2_bp": 60,
            "cdr_model_alternating_mean_linker_bp": 40
        }
    }
    ...
    with open(ledger_path, "w") as f:
        ...
        f.write(f"CHIP_PAIRS_CHRY\tProper pairs mapped to chrY alpha arrays (NC_060948.1)\tread_pairs\t{chry_noncdr}\t{total_proper_pairs}\t{chry_noncdr}\tChromosome Y arrays\n")
        ...
        f.write(f"CHIP_PAIRS_CDR_GATED\tMononucleosome-gated dyads (130-175 bp) analyzed in phasogram\tread_pairs\t411919\t{global_cdr}\t411919\tCDR mononucleosomes\n")
        ...
        f.write(f"DYAD_CONTRAST_RATIO\tRatio of Peak 1 (55 bp) to Dyad (15 bp) count\tfold_change\t{peak1_55_count}\t{dyad_15_count}\t66.00x\tPeak-to-dyad contrast\n")
        f.write(f"DYAD_NULL_DEPLETION\tFold-depletion relative to Geometric Null at 15 bp\tfold_change\t38333.62\t{dyad_15_count}\t15.36x\tGeometric null\n")
